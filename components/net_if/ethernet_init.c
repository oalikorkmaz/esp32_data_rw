...
// --- Manuel SPI Ethernet yapılandırması (menuconfig olmadan) ---
#define CONFIG_EXAMPLE_USE_SPI_ETHERNET      1
#define CONFIG_EXAMPLE_ETH_SPI_HOST          SPI3_HOST
...
#define CONFIG_EXAMPLE_ETH_SPI_INT0_GPIO     9
...
#define CONFIG_EXAMPLE_ETH_SPI_POLLING0_MS   100
